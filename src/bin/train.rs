use nocheat::{train_model, generate_default_model};
...
fn main() -> io::Result<()> {
    ...
    match command.as_str() {
        ...
        "custom" => {
            ...
            let labels: Vec<f64> = training_data.iter()
            ...
            // Train the model
            println!("Training model with {} examples ({} labeled)...", 
                     training_data.len(), labels.len());
